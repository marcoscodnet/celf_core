...
use Celf\Core\service\IEstadoReclamoService;
...
/**
 * servicio para EstadoReclamo
 *  
 * @author Marcos
 * @since 14-05-2020
 *
 */
class EstadoReclamoServiceImpl extends CrudService implements IEstadoReclamoService {

	
	protected function getDAO(){
		return DAOFactory::getEstadoReclamoDAO();
	}
