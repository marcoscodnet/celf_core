...
use Celf\Core\service\ITipoReclamoService;
...
/**
 * servicio para TipoReclamo
 *  
 * @author Marcos
 * @since 13-05-2020
 *
 */
class TipoReclamoServiceImpl extends CrudService implements ITipoReclamoService {

	
	protected function getDAO(){
		return DAOFactory::getTipoReclamoDAO();
	}
