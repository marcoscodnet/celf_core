 ...
 */
class Area extends \Celf\Core\model\Area implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Celf\\Core\\model\\Area' . "\0" . 'nombre', '' . "\0" . 'Celf\\Core\\model\\Area' . "\0" . 'email'];
        }
