 ...
 */
class TipoReclamo extends \Celf\Core\model\TipoReclamo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Celf\\Core\\model\\TipoReclamo' . "\0" . 'nombre', '' . "\0" . 'Celf\\Core\\model\\TipoReclamo' . "\0" . 'area'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoReclamo $proxy) {
