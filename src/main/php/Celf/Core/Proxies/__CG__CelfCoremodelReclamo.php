...
namespace celf\Core\Proxies\__CG__\Celf\Core\model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Reclamo extends \Celf\Core\model\Reclamo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Celf\\Core\\model\\Reclamo' . "\0" . 'nombre', '' . "\0" . 'Celf\\Core\\model\\Reclamo' . "\0" . 'tipoReclamo', '' . "\0" . 'Celf\\Core\\model\\Reclamo' . "\0" . 'fecha', '' . "\0" . 'Celf\\Core\\model\\Reclamo' . "\0" . 'usuario', '' . "\0" . 'Celf\\Core\\model\\Reclamo' . "\0" . 'estadoReclamo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reclamo $proxy) {
    ...
    public function getTipoReclamo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipoReclamo', []);

        return parent::getTipoReclamo();
    }
    ...
    public function setTipoReclamo($tipoReclamo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipoReclamo', [$tipoReclamo]);

        return parent::setTipoReclamo($tipoReclamo);
    }
    ...
    public function getEstadoReclamo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEstadoReclamo', []);

        return parent::getEstadoReclamo();
    }
    ...
    public function setEstadoReclamo($estadoReclamo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEstadoReclamo', [$estadoReclamo]);

        return parent::setEstadoReclamo($estadoReclamo);
    }
