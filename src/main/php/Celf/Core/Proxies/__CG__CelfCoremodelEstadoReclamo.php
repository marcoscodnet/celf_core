 ...
 */
class EstadoReclamo extends \Celf\Core\model\EstadoReclamo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Celf\\Core\\model\\EstadoReclamo' . "\0" . 'nombre', '' . "\0" . 'Celf\\Core\\model\\EstadoReclamo' . "\0" . 'orden'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EstadoReclamo $proxy) {
